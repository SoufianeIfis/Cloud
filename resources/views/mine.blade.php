					...
					<table class="table table-responsive">
						...
						<tr class="table-bordered">
							...
							<td class="table-bordered">
								<a href='/files/edit/{!! $file->id !!}'><button class="btn btn-primary" style="margin:10px">Edit</button></a>
								<a href='/files/delete/{!! $file->id !!}'><button class="btn btn-danger" style="margin:10px">delete</button></a>
							</td>
						</tr>
						@endforeach
					</table>
